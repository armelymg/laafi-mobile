class Constants {
  ...
  static const String urlBase = 'https://d8d8-2c0f-eb58-6c7-bf00-d6ba-f728-7081-476b.ngrok-free.app';

  static const String urlPharmacieGarde = 'https://pharmapi-tohtss4kua-uc.a.run.app/v1/api/pharmacie/ouaga';
  static const String urlProduitPageable = urlBase+'/v1/api/produit?size=5&page=149';
